...
To learn more, see the PDF manuals in the sst-macro repo or 
...
The projects contains modified source code for numerous apps, largely
consisting of extra pragmas to auto-skeletonize for macroscale simulation.
These mini-apps are all licensed under LGPL and therefore all source
code here retains the same restrictions.
