...
struct matvec_op {
  virtual void operator()(MatrixType& A,
                      VectorType& x,
                      VectorType& y) = 0;
};

void init_matrix(MatrixType& M,
                 const std::vector<MatrixType::GlobalOrdinalType>& rows,
                 const std::vector<MatrixType::LocalOrdinalType>& row_offsets,
                 const std::vector<int>& row_coords,
                 int global_nodes_x,
                 int global_nodes_y,
                 int global_nodes_z,
                 MatrixType::GlobalOrdinalType global_nrows,
...
void write_matrix(const std::string& filename, 
                  MatrixType& mat)
{
  typedef MatrixType::LocalOrdinalType LocalOrdinalType;
  typedef MatrixType::GlobalOrdinalType GlobalOrdinalType;
...
void
sum_into_row(MatrixType::GlobalOrdinalType row,
             size_t num_indices,
             const MatrixType::GlobalOrdinalType* col_inds,
             const MatrixType::ScalarType* coefs,
             MatrixType& mat)
{
  typedef MatrixType::GlobalOrdinalType GlobalOrdinal;
...
sum_in_symm_elem_matrix(size_t num,
                   const MatrixType::GlobalOrdinalType* indices,
                   const MatrixType::ScalarType* coefs,
                   MatrixType& mat)
{
  typedef MatrixType::ScalarType Scalar;
...
{
  typedef MatrixType::GlobalOrdinalType GlobalOrdinal;
  typedef MatrixType::LocalOrdinalType LocalOrdinal;
  double mem_MB = 0;
...
//------------------------------------------------------------------------
void
zero_row_and_put_1_on_diagonal(MatrixType& A, MatrixType::GlobalOrdinalType row)
{
  typedef MatrixType::GlobalOrdinalType GlobalOrdinal;
  typedef MatrixType::LocalOrdinalType LocalOrdinal;
  typedef MatrixType::ScalarType Scalar;
...
//------------------------------------------------------------------------
void
impose_dirichlet(MatrixType::ScalarType prescribed_value,
                    MatrixType& A,
                    VectorType& b,
                    int global_nx,
                    int global_ny,
                    int global_nz,
                    const std::set<MatrixType::GlobalOrdinalType>& bc_rows)
{
  typedef MatrixType::GlobalOrdinalType GlobalOrdinal;
  typedef MatrixType::LocalOrdinalType LocalOrdinal;
  typedef MatrixType::ScalarType Scalar;
  ...
  std::set<GlobalOrdinal>::const_iterator
...
struct matvec_std : public matvec_op {
...
struct matvec_overlap : public matvec_op {
void operator()(MatrixType& A,
                    VectorType& x,
                    VectorType& y)
{
