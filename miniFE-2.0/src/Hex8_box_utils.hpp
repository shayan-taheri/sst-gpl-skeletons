...
void
get_elem_nodes_and_coords(const simple_mesh_description& mesh,
                          ...
                          GlobalOrdinal* node_ords, Scalar* node_coords)
{
  ...
  GlobalOrdinal nodeID = get_id(global_nodes_x, global_nodes_y, global_nodes_z, elem_int_x, elem_int_y, elem_int_z);
  ...
  Scalar ix,iy,iz;
  get_coords(nodeID, global_nodes_x,global_nodes_y,global_nodes_z,ix,iy,iz);
