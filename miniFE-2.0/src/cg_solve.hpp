...
bool breakdown(VectorType::ScalarType inner,
               const VectorType& v,
               const VectorType& w)
{
  typedef VectorType::ScalarType Scalar;
  typedef TypeTraits<Scalar>::magnitude_type magnitude;
...
cg_solve(OperatorType& A,
         ...
         VectorType& x,
         matvec_op& matvec,
         OperatorType::LocalOrdinalType max_iter,
         TypeTraits<OperatorType::ScalarType>::magnitude_type& tolerance,
         OperatorType::LocalOrdinalType& num_iters,
         TypeTraits<OperatorType::ScalarType>::magnitude_type& normr,
         timer_type* my_cg_times)
{
  typedef OperatorType::ScalarType ScalarType;
  typedef OperatorType::GlobalOrdinalType GlobalOrdinalType;
  typedef OperatorType::LocalOrdinalType LocalOrdinalType;
  typedef TypeTraits<ScalarType>::magnitude_type magnitude_type;
