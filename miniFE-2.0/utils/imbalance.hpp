                  ...
                  bool record_in_doc)
{
  ...
  GlobalOrdinal local_nrows = get_num_ids(local_box);
  ...
  float tmp = percentage_difference(max_nrows, avg_nrows);
              ...
              YAML_Doc& doc)
{
  ...
  compute_imbalance(global_box, local_box,
  ...
  while (cur_imbalance < imbalance) {
    ...
    compute_imbalance(global_box, local_box,cur_imbalance, cur_std_dev, doc, false);
  }
}
